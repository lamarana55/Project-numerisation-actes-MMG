...
/// Accès distant à l'API des actes de mariage.
abstract interface class DeclarationMariageRemoteDataSource {
...
class DeclarationMariageRemoteDataSourceImpl
    implements DeclarationMariageRemoteDataSource {
  DeclarationMariageRemoteDataSourceImpl(this._dio);
  ...
  Future<ActeSummaryModel> creerDeclaration(
    ...
    try {
      final response = await _dio.post(
        ApiEndpoints.declarationMariage,
        data: payload,
